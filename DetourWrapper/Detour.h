...
enum SamplePolyFlags
{
    ...
    SAMPLE_POLYFLAGS_SLIME = 0x20,  // Swim: slime/swamp
...
namespace eqoa
{
    ...
    public:
        ...
        uint32_t check_los(const glm::vec3& start, const glm::vec3& target, float* range, uint16_t includeFlags, uint16_t excludeFlags);
